...
https://en.wikipedia.org/wiki/FAIR_data(explain)
...
%%% Thus the effect seen depends on time since demography and the relevant scale is in units of N generations.

%%% Why we don't see pops hit classical equilibrium. 
...
%%% Everything happens faster with $\xi$. $\xi$ shows return to equilibrium too.
Each of these dynamics occurred more quickly for $\xi/\xi_0$, as approaches to equilibrium are more rapid for rare variants relative to common variants.
