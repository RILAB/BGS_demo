...
However, signals using rare frequency bins such as $\xi$ are inherently more difficult to capture, partly because it is less affected than $\pi$ because BGS perturbs common frequency bins of the SFS more than rare ones [57].
...
MGS and JR-I would like to acknoweledge funding from NSF Plant Genome Grant 1238014.
